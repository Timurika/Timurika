### Всем привет 👋
## Меня зовут Церцвадзе Марика 

## Обо мне 
Я - начинающий аналитик данных, люблю работу с цифрами и все, что с ними связано.
...
<!--
**Timurika/Timurika** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
